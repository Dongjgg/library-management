<template>
    <div>
            ...
            <div style="flex: 1;text-align: right; padding-right: 20px">
                <el-dropdown size="medium" trigger="hover">
                    ...
                    <el-dropdown-menu slot="dropdown" style="margin-top: -5px">
                        <el-dropdown-item><div style="width: 50px;text-align: center" @click="logout">注销</div></el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
            </div>
        </div>
        ...
        <div style="display: flex">
            <!--侧边栏-->
            <!--calc函数里面的运算符要空格,overflow: hidden;超出部分隐藏-->
            <div style="width: 200px;min-height: calc(100vh - 62px);overflow: hidden; margin-right: 2px; background-color: white">
                <el-menu :default-active="$route.path"  router class="el-menu-demo">   <!--:default-openeds="['/']" 设置默认打开的菜单-->
                    <!--index里面的内容就是切换的路由地址-->
                    <el-menu-item index="/">
